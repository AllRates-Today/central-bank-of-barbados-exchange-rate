'use strict';
// Central Bank of Barbados exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbbd';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BBD', { apiKey }). */
